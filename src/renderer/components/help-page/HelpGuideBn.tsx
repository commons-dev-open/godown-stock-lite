    ...
    overview: (
      <div className="space-y-1">
        <p className="text-sm text-[var(--color-text-secondary)] mb-4">
          {terms.appName}{" "}
          মূলত ডেস্কটপে চালানোর জন্য তৈরি একটি ব্যবসার অ্যাপ—স্টক, বিক্রি, মহাজনের কাছ থেকে বাকিতে
        ...
        <HelpSubSection title="এক অংশ আরেক অংশের সঙ্গে কীভাবে জড়িত">
          <p className="mb-2">
            ...
            শুধু বলে মহাজনের কাছে কত দেনা বা কত শোধ হল—কাউন্টারের নগদের খাতা একা এটায় মিলে না। দিন
      ...
      <div className="space-y-1">
        ...
        <HelpSubSection title="লেজার">
          <p className="mb-2">
            ...
            ফিল্টার, এক্সপোর্ট/প্রিন্ট—এক মহাজন মিলাতে গ্লোবাল {terms.navTransactions} খুঁজে বের
            করার চেয়ে দ্রুত।
          </p>
        </HelpSubSection>
        <HelpSubSection title="মডালে কী যায় (সংক্ষেপে)">
          <p className="mb-2">
            বাকিতে ক্রয়ের লাইনে GST হার ও ইনক্লুসিভ/এক্সক্লুসিভ, ঐচ্ছিক মহাজনের ইনভয়েস নম্বর,
        ...
        <HelpSubSection title={terms.txAddCreditPurchase}>
          <HelpStepList
            steps={[
              ...
              `ঐচ্ছিক মহাজনের ইনভয়েস নম্বর, স্ক্যান/ছবি, নোট, আর অংশীদার টাকা (₹) এখনই পরিশোধ—মেথড ও রেফারেন্সসহ।`,
