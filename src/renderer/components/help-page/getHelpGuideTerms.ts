...
export function getHelpGuideTerms(i18n: I18n) {
  ...
  return {
    ...
    navUnits: tNav("units"),
    navStock: tNav("stock"),
    navStockHistory: tNav("stock_history"),
    ...
    qaStockHistory: tHome("quickActions.stockHistory.title"),
    ...
    homeHeroMetricLast7Days: tHome("hero.metrics.last7Days"),
    homeHeroMetricThisCalendarWeek: tHome("hero.metrics.thisCalendarWeek"),
